...
const languageTexts = {
  'en-GB': {
    donate: {
      title: 'Donate',
      location:
        'Donations go to the Ukraine Humanitarian Appeal, Slava Ukraini!',
...
export const links = {
  ...
  review:
    'https://chrome.google.com/webstore/detail/cock-blocker-for-omegle/bmcnbhnpmbkcpkhnmknmnkgdeodfljnc/reviews',
